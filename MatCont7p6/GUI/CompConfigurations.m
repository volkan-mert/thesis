classdef CompConfigurations
    ...
    methods
        function obj = CompConfigurations()
            ...
            obj.OrbitConfsLyapExp = {};
            for k = 1:length(obj.OrbitConfs); obj.OrbitConfsLyapExp{end+1} = SimConf_LyapExp('LyapunovExponent', 'LyapExp' , obj.OrbitConfs{k}); end     
            ...
            conflist = [obj.OrbitConfs,obj.OrbitConfsHom,obj.OrbitConfsLyapExp]; % maybe switch the order
 ...
 %           conflist{end+1} = ContConf_LPC('GPD' , @init_GPD_LPC); %We do not have such a starter (yet)
