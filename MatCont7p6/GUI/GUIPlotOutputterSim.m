classdef GUIPlotOutputterSim < handle
    ...
    methods
        ...
        %Only do this if there was already any data, needed to plot ALL
        %Lyapunov Exponents correctly (ie keep array rather vector)
        %Inspiration for min/max for cycles?
          if ~isempty(obj.previouspoint{1})
