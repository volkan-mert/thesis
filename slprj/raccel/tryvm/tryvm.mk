###########################################################################
## Makefile generated for component 'tryvm'. 
## 
## Makefile     : tryvm.mk
## Generated on : Sat Jul 18 15:41:51 2026
## Final product: ./tryvm.dll
...
START_DIR                 = C:/Users/t0900/Documents/MATLAB/Volkan
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = tryvm_comp.rsp
CMD_FILE                  = tryvm.rsp
...
DEFINES_STANDARD = -DMODEL=tryvm -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/tryvm/rt_nonfinite.c $(START_DIR)/slprj/raccel/tryvm/tryvm.c $(START_DIR)/slprj/raccel/tryvm/tryvm_capi.c $(START_DIR)/slprj/raccel/tryvm/tryvm_data.c $(START_DIR)/slprj/raccel/tryvm/tryvm_tgtconn.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = rt_nonfinite.obj tryvm.obj tryvm_capi.obj tryvm_data.obj tryvm_tgtconn.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/tryvm/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/tryvm/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/tryvm/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/tryvm/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/tryvm/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.obj : $(START_DIR)/slprj/raccel/tryvm/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


tryvm.obj : $(START_DIR)/slprj/raccel/tryvm/tryvm.c
	$(CC) $(CFLAGS) -o "$@" "$<"


tryvm_capi.obj : $(START_DIR)/slprj/raccel/tryvm/tryvm_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


tryvm_data.obj : $(START_DIR)/slprj/raccel/tryvm/tryvm_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


tryvm_tgtconn.obj : $(START_DIR)/slprj/raccel/tryvm/tryvm_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
